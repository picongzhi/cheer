package com.pcz.cheer.exception.handler;
...
public class GlobalExceptionHandler {
    ...
    public ApiResponse handleException(Exception e) {
        if (e instanceof NoHandlerFoundException) {
            ...
            log.error("[全局异常拦截] HttpRequestMethodNotSupportedException: 请求方法: {}, 支持请求方法: {}",
            ...
            return ApiResponse.of(Status.BAD_REQUEST.getCode(),
                    CollUtil.getFirst(((ConstraintViolationException) e)
